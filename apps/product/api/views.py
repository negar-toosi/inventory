...
from apps.product.api.serializers import AddProductRequest, AddProductResponse
...
class AddProductAPI(APIView):
    @extend_schema(request=AddProductRequest, responses={201: AddProductResponse})
    def post(self, request: Request) -> CustomResponse:
        ...
        response = AddProductResponse(product)
